// Code generated by cmd/gen-services; DO NOT EDIT.
// Source: data/iana-service-names-port-numbers.csv (IANA, public domain).
// Regenerated 2026-04-23 via `make regen-data`.
//
// See scry-plan.md §10 #23 for the data-source decision.

package output

// Service returns a best-guess canonical service name for the given
// TCP port, or "" if the port is not in the IANA registry.
func Service(port uint16) string {
	return services[port]
}

// services is the generated TCP port → name map (5886 entries).
